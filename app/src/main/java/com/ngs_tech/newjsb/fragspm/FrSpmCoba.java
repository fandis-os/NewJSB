...
public class FrSpmCoba extends Fragment {
...
//    private String url  = "http://mudikqu.com/toll_api/index.php/api/ListSpm/1";


    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fr_spm_coba, container, false);

        AndroidNetworking.initialize(getContext());

        mList                   = view.findViewById(R.id.recycle_alat_tol);
        spmsatuModelList        = new ArrayList<>();
        adapter                 = new AdapterSpmCoba(getContext(), spmsatuModelList);
