...
public class FrSpmDelapan extends Fragment {
    ...
    private String url  = "http://mudikqu.com/toll_api/index.php/api/ListSpm/8";

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fr_spm_delapan, container, false);
