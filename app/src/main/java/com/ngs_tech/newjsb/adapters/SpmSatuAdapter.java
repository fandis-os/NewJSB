...
public class SpmSatuAdapter extends RecyclerView.Adapter<SpmSatuAdapter.ViewHolder> {

    private Context context;
    private List<SpmSatuModel> list;

    public SpmSatuAdapter(Context context, List<SpmSatuModel> spmsatuModelList) {
    ...
    @NonNull
    @Override
    public SpmSatuAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_spm_satu, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final SpmSatuAdapter.ViewHolder holder, int position) {
...
//                        break;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            spinLajur.setAdapter(adapterLajur);
